...
export default function Header({ onAdd }: { onAdd: () => void }) {
  return (
    <header className="food-bg-white food-sticky food-top-0 food-z-30 food-border-b food-border-black/5 food-backdrop-blur">
      <div className="food-container food-mx-auto food-max-w-7xl food-px-4 food-flex food-items-center food-justify-between food-py-3">
        ...
        <button
          ...
          className="food-bg-orange-500 food-text-white hover:food-bg-orange-600 food-rounded-full food-px-5 food-py-2 food-font-medium food-transition"
          onClick={onAdd}
        >
          Add Food
        </button>
